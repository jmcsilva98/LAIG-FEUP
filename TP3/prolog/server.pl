...
parse_input(bot_move(Board,Player,Difficulty), Answer):-choose_move(Player,Board,NewBoard2,BotPlayer1,BotPlayer2,Difficulty),boardToNumbers(NewBoard2,Answer).
test(_,[],N) :- N =< 0.
